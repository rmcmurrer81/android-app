...
public final class TravelAutomation {
    ...
    public static Result apply(
        ...
        boolean wishImpliesWatch = containsAny(lower,
                "always wanted to visit", "always wanted to go", "dream of visiting", "dreamed of visiting");
        boolean flexible = isNoPreference(lower) && hasDealContext(history)
                || containsAny(lower, "flexible dates", "any dates", "any days", "whenever is cheapest");
