...
- Objective result: `PASS` (108/108 checks)
- Turns: 14
...
| 2 | interest_memory | online | ONLINE_WORKERS_AI | 5 | PASS | 0 |
| 3 | trip_memory | online | ONLINE_WORKERS_AI | 6 | PASS | 0 |
| 4 | interest_trip_continuity | online | ONLINE_WORKERS_AI | 5 | PASS | 0 |
| 5 | nearby_event_without_source | online | TOOL_UNAVAILABLE | 5 | PASS | 0 |
| 6 | official_event_ticket_link | online | ONLINE_WORKERS_AI | 6 | PASS | 1 |
| 7 | flight_calm | offline | LOCAL_TOOL_RESULT | 4 | PASS | 0 |
| 8 | offline_conversation | offline | OFFLINE_LOCAL | 5 | PASS | 0 |
| 9 | connected_failure_fallback | failure | ONLINE_FAILED_FELL_BACK_OFFLINE | 5 | PASS | 0 |
| 10 | automatic_online_return | online | ONLINE_WORKERS_AI | 5 | PASS | 0 |
| 11 | correction_after_error | online | ONLINE_WORKERS_AI | 5 | PASS | 0 |
| 12 | no_email_hallucination | online | ONLINE_WORKERS_AI | 6 | PASS | 0 |
| 13 | no_location_hallucination | online | ONLINE_WORKERS_AI | 5 | PASS | 0 |
